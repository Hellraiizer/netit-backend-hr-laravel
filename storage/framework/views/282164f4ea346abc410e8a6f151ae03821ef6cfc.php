...
unset($__errorArgs, $__bag); ?>
                          ...
                          <div class="form-group row">
                            <label for="names" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Names')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="age" class="form-control <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FinalProject\resources\views/auth/register.blade.php ENDPATH**/ ?>